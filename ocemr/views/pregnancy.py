...
def pregnancy_new(request,id):
	...
	if request.method == 'POST': # If the form has been submitted...
		form = NewPregnancyForm(p, request.user, request.POST) # A form bound to the POST data
		if form.is_valid(): # All validation rules pass
                        pr = Pregnancy(
                                patient=form.cleaned_data['patient'],
                                deliveryDate=form.cleaned_data['deliveryDate'],
                                gestationalAge=form.cleaned_data['gestationalAge'],
                                gestationalAgePlusDays=form.cleaned_data['gestationalAgePlusDays'],
                                ...
                                postpartumComplications=form.cleaned_data['postpartumComplications'],
                                breastfeedingProblems=form.cleaned_data['breastfeedingProblems'],
...
def pregnancy_edit(request,id,pregid):
	...
	if request.method == 'POST': # If the form has been submitted...
		...
		if form.is_valid(): # All validation rules pass
                        ...
                        pr.gestationalAgePlusDays=form.cleaned_data['gestationalAgePlusDays']
                        ...
                        pr.postpartumComplications=form.cleaned_data['postpartumComplications']
                        pr.breastfeedingProblems=form.cleaned_data['breastfeedingProblems']
		...
		form = NewPregnancyForm(p, request.user, initial={
                    'patient': p,
