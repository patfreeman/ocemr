...
def vitals_bp(request, id):
    ...
    plt.grid(True)
    plt.axhspan(ymin=90, ymax=140, color="b", alpha=0.2)
    plt.axhspan(ymin=60, ymax=90, color="g", alpha=0.2)
    ...
    try:
        plt.xlim(
            matplotlib.dates.date2num(min(bpS_date_list + bpD_date_list)) - 1,
...
def vitals_temp(request, id):
    ...
    plt.grid(True)
    plt.axhspan(ymin=36.3, ymax=37.3, color="g", alpha=0.5)
...
def vitals_hrrr(request, id):
    ...
    try:
        plt.xlim(
            matplotlib.dates.date2num(min(hr_date_list + rr_date_list)) - 1,
...
def vitals_height_weight(request, id):
    ...
    try:
        plt.xlim(
            matplotlib.dates.date2num(min(height_date_list + weight_date_list)) - 1,
...
def vitals_spo2_o2(request, id):
    ...
    try:
        plt.xlim(
            matplotlib.dates.date2num(min(date_list + date_list2)) - 1,
