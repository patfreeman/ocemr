...
urlpatterns = [
    ...
    url(
        r"^village_merge_wizard/(?P<villageId>[0-9]+)/(?P<villageIncorrectId>[0-9]+)/$",
        views.util.village_merge_wizard_go,
    ),
    url(r"^autospel_name/(?P<inapp>.+)/(?P<inmodel>.+)/$", views.util.autospel_name),
    url(
        r"^autocomplete_name/(?P<inapp>.+)/(?P<inmodel>.+)/$",
        views.util.autocomplete_name,
    ),
    url(
        r"^autosearch_title/(?P<inapp>.+)/(?P<inmodel>.+)/$",
        views.util.autosearch_title,
    ),
    ...
    url(
        r"^select_date_for_patient_queue/$", views.patient.select_date_for_patient_queue
    ),
    ...
    url(
        r"^patient/edit/alt_contact_name/(?P<id>\d+)/$",
        views.patient.patient_edit_alt_contact_name,
    ),
    url(
        r"^patient/edit/alt_contact_phone/(?P<id>\d+)/$",
        views.patient.patient_edit_alt_contact_phone,
    ),
    ...
    url(
        r"^patient/schedule_walkin_visit/(?P<id>\d+)/$",
        views.patient.schedule_walkin_visit,
    ),
    ...
    url(
        r"^visit/(?P<id>\d+)/allergy/delete/(?P<oid>\d+)/$",
        views.visit.visit_allergy_delete,
    ),
    url(r"^visit/(?P<id>\d+)/past/$", views.visit.visit_past),
    url(r"^visit/(?P<id>\d+)/subj/$", views.visit.visit_subj),
    url(
        r"^visit/(?P<id>\d+)/subj/new/(?P<symptomtypeid>\d+)/$",
        views.visit.visit_subj_new,
    ),
    url(
        r"^visit/(?P<id>\d+)/subj/edit/(?P<visitsymptomid>\d+)/$",
        views.visit.visit_subj_edit,
    ),
    url(
        r"^visit/(?P<id>\d+)/subj/delete/(?P<visitsymptomid>\d+)/$",
        views.visit.visit_subj_delete,
    ),
    ...
    url(
        r"^visit/(?P<id>\d+)/obje/vital/delete/(?P<oid>\d+)/$",
        views.visit.visit_obje_vital_delete,
    ),
    url(
        r"^visit/(?P<id>\d+)/obje/examNote/new/(?P<examnotetypeid>\d+)/$",
        views.visit.visit_obje_examNote_new,
    ),
    url(
        r"^visit/(?P<id>\d+)/obje/examNote/edit/(?P<examnoteid>\d+)/$",
        views.visit.visit_obje_examNote_edit,
    ),
    ...
    url(
        r"^visit/(?P<id>\d+)/labs/new/(?P<labtypeid>\d+)/$", views.visit.visit_labs_new
    ),
    url(r"^visit/(?P<id>\d+)/plan/$", views.visit.visit_plan),
    url(r"^visit/(?P<id>\d+)/plan/diag/new/$", views.visit.visit_plan_diag_new),
    url(
        r"^visit/(?P<id>\d+)/plan/diag/new/(?P<dtid>\d+)/$",
        views.visit.visit_plan_diag_new_bytype,
    ),
    ...
    url(
        r"^visit/(?P<id>\d+)/cost_estimate_detail/$",
        views.visit.visit_cost_estimate_detail,
    ),
    ...
    url(
        r"^visit/(?P<id>\d+)/preg/edit/(?P<pregid>\d+)/$",
        views.pregnancy.pregnancy_edit,
    ),
    ...
    url(
        r"^diag/(?P<id>\d+)/stat_change/(?P<newstat>\w+)/$", views.diag.diag_stat_change
    ),
    url(r"^diag/(?P<id>\d+)/edit/notes/$", views.diag.diag_edit_notes),
    url(r"^diag/(?P<id>\d+)/history/$", views.diag.diag_history),
    url(
        r"^diag/patienttypehistory/(?P<pid>\d+)/(?P<dtid>\d+)/$",
        views.diag.diag_patienttypehistory,
    ),
